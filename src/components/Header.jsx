...
import { getLastUpdated, getDate } from "@/stores/selectors";
            ...
            <HeaderWrapper>
                <Grid.Container gap={1} justify="space-between"  alignItems="center">
                    <Grid md={6}>
                        <Grid.Container gap={1}>
                            ...
                            <Grid>
                                ...
                                {/*    { format(new Date(), "'Today is' eeee yyyy-MM-dd") }*/}
                                {/*</Text>*/}
                    ...
                    <Grid md={6}>
                        <Grid.Container gap={1}>
                            <Grid>
                                <NextLink href='/brokers' title={"Brokers"} color>Brokers</NextLink>
                                <NextLink href='/links' title={"Usefull Links"} color>Links</NextLink>
                            </Grid>
                        </Grid.Container>
                    </Grid>
