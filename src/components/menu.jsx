...
import {Button, useClasses} from "@geist-ui/core";
...
const DropdownSelector = ({ fetchCustomData }) => {
    ...
    const handleDataFetching = (key, value) => {
        ...
        /**
         * This function invokes when user selects an item from dropdown,
...
export const Item = ({title, href, className, onClick = () => {}}) => {
    return (
        <li className={useClasses("", className)}><a href={href} onClick={onClick}>{ title }</a></li>
    )
}